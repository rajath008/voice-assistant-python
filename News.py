...
def latestNews():
    api_dict={
        "business":"https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=dde53a9d9d8a4010b67b56a1b8a45912",
        ...
        "sports":"https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=dde53a9d9d8a4010b67b56a1b8a45912",
        "technology":"https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=dde53a9d9d8a4010b67b56a1b8a45912"
    }

    content=None
    url=None
    print("Latest news about business,sports,health,entertainment and technology available")
    speak("Latest news about business,sports,health,entertainment and technology available")
    ...
    speak(f"First News about in the field of {field}")
